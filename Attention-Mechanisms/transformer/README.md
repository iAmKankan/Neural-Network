...
* [**Classification of Transformers**](#-classification-of-transformers)
  * [BERT](https://github.com/iAmKankan/Neural-Network/blob/main/Attention-Mechanisms/transformer/BERT.md) 
* [**The Model**](#-the-model)
...
* **Transformer in detail**
  * [**_The Encoder_**](#-the-encoder)
    * The input
    * Embedding Layer
    * Self-Attention
      * Vector Calculation - Self-Attention
      * Matrix Calculation - Self-Attention
...
<p align="center"><ins><i><b>The transformer architecture</b></i></ins>.</p>
